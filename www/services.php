...
<body>
	...
	<h2 style="position: relative; left: 20%;">Our service</h2>
		<table class="classForTableService" >
			<tr>
				<th>Procedure</th>
				<th>Doctor</th>
				<th>Value</th>
			...
			<tr>
				<td>Inoculation 1 type</td>
				<td>Kozlov<br></td>
				<td>15$</td>		
				<td>Be healthy</td>	
			</tr>
			<tr>
				<td>Inoculation 10 type</td>
				<td>Dubovskaya<br></td>
				<td>100$</td>
				<td>Be healthy</td>
			</tr>
			<tr>
				<td>Inoculation 14 type</td>
				<td>Murr<br></td>
				<td>4,3$</td>
				<td>Be healthy</td>
			</tr>
			<tr>
				<td>Inoculation 12 type</td>
				<td>Smith<br></td>
				<td>79,99$</td>
				<td>Be healthy</td>
			</tr>
			...
			<tr>
				<td>Inoculation 19 type</td>
				<td>Kozlov<br></td>
				<td>15$</td>		
				<td>Be healthy</td>	
			</tr>
			<tr>
				<td>Inoculation 41 type</td>
				<td>Kozlov<br></td>
				<td>15$</td>		
				<td>Be healthy</td>	
			</tr>
			<tr>
				<td>Inoculation 71 type</td>
				<td>Kozlov<br></td>
				<td>15$</td>		
				<td>Be healthy</td>	
			</tr>
        ...
        <pre style="position: relative; top: 15%; left: 65%; font-size: 18px; ">
            Mn – Fr   8:00–20:00
            Str       9:00–19:00
            Sn        day off
        </pre>
